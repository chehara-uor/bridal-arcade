...
const allowedFields = ["name", "description", "short_description", "sku", "regular_price", "sale_price", "parent", "child", "catalog_visibility", "manage_stock", "stock_quantity", "stock_status", "virtual", "owner_location", "owner_mobile", "owner_commission", "chest_size", "wear_count", "lead_time_days", "in_store_now", "dry_clean_fee", "security_deposit", "delivery_fee", "owner_declared_value"];
